			...
			<div class="col-xs-12 col-md-6 col-md-offset-3">
				<form action="index.php" method="post">
				  <div class="form-group">
				    <input type="search" class="form-control" name="search" placeholder="Enter location here...">
				  </div>
		...
		<div class="col-xs-12 col-md-4 col-md-offset-2 text-left">
			...
			<?php 
			    ...
			    for($i=$init;$i<$end;$i++){
					...
					echo "<br>";
					echo "<b>Directions: </b>".nl2br(str_replace('<br />', '/r/n', $place->directions));
					echo "<br>";
					echo "<b>Description: </b>".nl2br(str_replace('<br />', '/r/n', $place->activities[0]->description));
					echo "<br>";
