    ...
    <div class="text-center" style="margin-top: 100px;">
		...
		<div class="row">
			<div class="col-xs-12 text-left">
				...
				<a href="https://twitter.com/intent/tweet?text=Hello%20world" data-size="large" class="twitter-share-button" data-show-count="false">Tweet</a> <script type="text/javascript">
