	...
	?>
		...
		<div class="row" style="margin-bottom: 30px">
		  	...
		  	<div class="col-xs-12 col-md-3">
				  ...
				  <button style="float:right" type="submit" class="btn btn-danger btn-block" style="font-size: 20px"><i style="font-size: 40px"  class="glyphicon glyphicon-remove"></i><br>Remove Hike</button>
				</form>
		  	</div>
		</div>
	<?php
