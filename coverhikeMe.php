      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand"><small>I took a walk in the woods and come out taller than the trees.<br> - Henry David Thoreau</small></h3>
              <nav>
              </nav>
            </div>
          </div>
          ...
          <div class="inner cover">
            ...
            <p class="lead">
            <a href="http://ec2-54-213-132-61.us-west-2.compute.amazonaws.com/hikeMe/index.php" class="btn btn-lg btn-stripe">Enter hikeMe</a></p>
          </div>
